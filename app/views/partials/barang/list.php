                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Jumlah_Aset"> Jumlah Aset Barang</th>
                                                <th  class="td-Nilai_Per_Aset"> Nilai Per Barang</th>
                                                <th  class="td-Asal_Perolehan"> Asal Barang</th>
                                                <th  class="td-Tahun_Perolehan"> Tahun Masuk Barang</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
